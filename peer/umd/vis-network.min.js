          ...
          [
            {
              ...
              value: function (t, e) {
                ...
                if (
                  ...
                  e.customLabel
                    ? C_(e.customLabel)
                      ? (t.label = e.customLabel)
                      : C_(t.customLabel) || (t.label = void 0)
                    : C_(e.label)
                    ? (t.label = e.label)
      ...
      return (
        wu(t, [
          ...
          },
          {
            ...
            value: function (t) {
              return (
                t.customLabel && (t.label = t.customLabel),
                new JE(
                  t,
                  this.body,
                  this.images,
                ...
                s = {
                  ...
                  label:
                    null !==
                      (i =
                        null ===
                          (o = this.body.data.edges.get(
                            this.edgeBeingEditedId
                          )) || void 0 === o
                          ? void 0
                          : o.customLabel) && void 0 !== i
                      ? i
                      : null ===
                          (n = this.body.data.edges.get(
                            this.edgeBeingEditedId
                          )) || void 0 === n
                      ? void 0
                      : n.label,
                },
                a = this.options.editEdge;
              if (
                ("object" === gu(a) && (a = a.editWithoutDrag),
                "function" == typeof a)
              ) {
                if (2 !== a.length)
                  throw new Error(
                ...
                a(s, function (t) {
                  null == t || "editEdge" !== r.inMode
                    ? (r.body.edges[s.id].updateEdgeType(),
                      r.body.emitter.emit("_redraw"),
                      r.showManipulatorToolbar())
                    : (r.body.data.edges.getDataSet().update(t),
                      r.selectionHandler.unselectAll(),
                      r.showManipulatorToolbar());
                });
              } else
                this.body.data.edges.getDataSet().update(s),
                  this.selectionHandler.unselectAll(),
                  this.showManipulatorToolbar();
            },
          },
