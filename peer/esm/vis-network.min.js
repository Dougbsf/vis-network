  ...
  var n = t.edges,
    r = Df(n).call(n, function (t) {
      ...
      return (
        ...
        null != t.customLabel && (e.label = t.customLabel),
            ...
            value: function (t, e, i) {
              ...
              if (!1 !== this.labelDirty || this.differentState(e, i)) {
                var n = this._processLabelText(
                  ...
                  e,
                  i,
                  null !== (o = this.elementOptions.customLabel) && void 0 !== o
                    ? o
                    : this.elementOptions.label
                );
      ...
      },
      {
        ...
        value: function (t, e, i, o, n, r) {
          ...
          var s = e,
            a = i;
          if (
            (void 0 !== this.options.shapeProperties.customCoordinateOrigin
              ? ((this.left =
                  e + this.options.shapeProperties.customCoordinateOrigin.x),
                (this.top =
                  i + this.options.shapeProperties.customCoordinateOrigin.y))
              : "top-left" === this.options.shapeProperties.coordinateOrigin
              ? ((this.left = e),
                (this.top = i),
                (s += this.width / 2),
      ...
      },
      {
        ...
        value: function (t, e) {
          this.resize(),
            void 0 !== this.options.shapeProperties.customCoordinateOrigin
              ? ((this.left =
                  t + this.options.shapeProperties.customCoordinateOrigin.x),
                (this.top =
                  e + this.options.shapeProperties.customCoordinateOrigin.y))
              : "top-left" === this.options.shapeProperties.coordinateOrigin
        ...
        [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                O_(e.customLabel)
                  ? (t.customLabel = e.customLabel)
                  : O_(t.customLabel) || (t.customLabel = void 0),
                O_(e.label)
                  ? (t.label = e.label)
      ...
      wu(t, [
              ...
              !0 === (e = s[r[a]]).connected &&
                ...
                (void 0 !== e.edgeType.via
                  ? ((t =
                    ...
                    (o = e.edgeType.via),
                    (n = e.from),
                    this._calculateSpringForce(i, o, 0.5 * t),
                    this._calculateSpringForce(o, n, 0.5 * t))
                  : ((t =
                      void 0 === e.options.length
        ...
        },
        {
          ...
          value: function (t, e, i) {
            var o = t.x - e.x,
              n = t.y - e.y,
              r = Math.max(Math.sqrt(o * o + n * n), 0.01),
          ...
          value: function (t, e) {
            var i,
              ...
              r = {
                ...
                label:
                  null ===
                    (i = this.body.data.edges.get(this.edgeBeingEditedId)) ||
                  void 0 === i
                    ? void 0
                    : i.label,
                customLabel:
                  null ===
                    (o = this.body.data.edges.get(this.edgeBeingEditedId)) ||
                  void 0 === o
                    ? void 0
                    : o.customLabel,
              },
              s = this.options.editEdge;
            if (
              ("object" === gu(s) && (s = s.editWithoutDrag),
              "function" == typeof s)
            ) {
              if (2 !== s.length)
                throw new Error(
              ...
              s(r, function (t) {
                null == t || "editEdge" !== n.inMode
                  ? (n.body.edges[r.id].updateEdgeType(),
                    n.body.emitter.emit("_redraw"),
                    n.showManipulatorToolbar())
                  : (n.body.data.edges.getDataSet().update(t),
                    n.selectionHandler.unselectAll(),
                    n.showManipulatorToolbar());
              });
            } else
              this.body.data.edges.getDataSet().update(r),
                this.selectionHandler.unselectAll(),
                this.showManipulatorToolbar();
          },
        },
